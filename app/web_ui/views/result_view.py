...
from app.web_ui.serverconfig import ScanResult


logger = logging.getLogger("Server")
scan_result = ScanResult()
wvs_result_list = scan_result.wvs_result_list
...
def scan_result_handler(msg):
    ...
    wvs_result_list.append(scan_res)
...
def result():
    return render_template("result.html", title="扫描结果", scan_result_list=wvs_result_list)